...
| [MainLayout.kt](src/main/kotlin/com/example/vok/MainLayout.kt) | The main frame of the app; guarantees unified look-and-feel of your app. Hosts the views as the user navigates througout the app.
